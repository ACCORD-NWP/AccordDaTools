#This script can be used for satellite  obs.
#Be CAREFUL: Fill the path  in read0 and also the name of the ouput file 
...
{ 
  ...
  for ( isens in lsens )
  {
    ...
    if (nrow(msSENS) > 0)
    {
      ...
      for (ichan in plchan)
      {
        png(paste("diag_cov_",isat,"_",isens,"_",ichan,".png",sep=""))
      ...
      for (ichan in plchan)
      {
        png(paste("diag_cor_",isat,"_",isens,"_",ichan,".png",sep=""))
